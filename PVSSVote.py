...
def TallierRegistration(begin,end):
...
def TallierShareAndRecon(begin,end,acc):
    ...
    for j in range(0,101):
        if (str(all_votescore[0])==str(database[j])):   # Compare the result with the pre-processed result and find the same value 
            print("result : "+str(j)+"  votes")  
...
def IncentiveVote():
    ...
    TallierRegistration(1,10)    
    # The 1~5 accounts register to become tallier       
    print("............................................Voting phase...........................................")
    # Vote begin   
    acc=VoterCastVote(11,30) 
